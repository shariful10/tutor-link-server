...
const getUser = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.default.find({ role: 'tutor' });
    return result;
});
...
const updateUser = (email, data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.default.findOneAndUpdate({ email }, { $set: data }, { new: true, runValidators: true });
    return result;
});
exports.userService = {
    createUser,
